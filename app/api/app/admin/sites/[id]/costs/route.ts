...
/**
 * GET /api/app/admin/sites/[id]/costs
 *
 * Query params: from / to (ISO date, default = current fortnight)
 *
 * Returns materialCost, wagesCost, projectCost for this site.
 */
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(
      { ok: true, startISO, endISO, data: row },
      { headers: CORS },
    );
  } catch (e: any) {
