...
/**
 * GET /api/app/foreman/employees/face-status?show=active|all
 *
 * Foreman equivalent of the supervisor face-status route (see
 * app/api/app/supervisor/employees/face-status/route.ts, which this
 * mirrors) - backs office-app's (foreman-stack)/face-verifications.tsx.
 * Same crew-ownership definition as GET /api/app/foreman/employees.
 */
