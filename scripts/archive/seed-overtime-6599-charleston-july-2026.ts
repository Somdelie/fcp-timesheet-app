...
const rows: OvertimeSeedRow[] = [
  { foremanName: "SINDISO NCUBE", workDate: "2026-07-18", code: "S+0", hours: 1 },
  { foremanName: "SINDISO NCUBE", workDate: "2026-07-19", code: "S+0", hours: 2 },
];
